...
![사이트 유형 선택 대화상자](../../assets/unit0/u0-s01.png)
...
![서식 파일 목록](../../assets/unit0/u0-s02.png)

여러 템플릿이 나타납니다. 목록을 **스크롤 맨 아래**까지 내립니다.

![비어 있음 템플릿](../../assets/unit0/u0-s03.png)
...
!['비어 있음' 템플릿 미리보기](../../assets/unit0/u0-s04.png)
...
![사이트 이름 입력 화면](../../assets/unit0/u0-s05.png)
...
![사이트 정보 입력 완료](../../assets/unit0/u0-s06.png)
...
![언어 설정 화면](../../assets/unit0/u0-s07.png)

언어가 **한국어**로 설정되어 있는지 확인합니다.
...
![HR Lab 사이트 생성 완료](../../assets/unit0/u0-s08.png)
...
[0-2. 지원자 마스터 List 생성 →](./u0-2-list-create.md)
